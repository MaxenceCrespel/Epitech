...
const Permissions = new mongoose_1.Schema({
    permissionsList: { type: mongoose_1.Schema.Types.Mixed, required: true, default: () => permissionsList_1.default },
});
exports.default = mongoose_1.default.model('Permissions', Permissions);
