...
class Patterns:
    def __init__(self, player: int, opponent: int, empty: int, debug=None):
        ...
        self.patterns = [
            ...
            (self.pattern_five_A, 1000000),
            (self.pattern_five_B, 1000000),
            (self.pattern_five_C, 1000000),
            (self.pattern_five_D, 1000000),
            (self.pattern_five_E, 1000000),
            (self.pattern_five_F, 1000000),
            (self.pattern_fork_three, 100000),
        ]
    ...
    def pattern_five_A(self, x, y, board, player):
        if x < 3 or y < 3 or x > 12 or y > 12:
            return False
        return self.check_pattern(x, y, self.pattern_array["fiveA"], board)

    def pattern_five_B(self, x, y, board, player):
        if x < 3 or y < 3 or x > 12 or y > 12:
            return False
        return self.check_pattern(x, y, self.pattern_array["fiveB"], board)

    def pattern_five_C(self, x, y, board, player):
        if x < 3 or y < 3 or x > 12 or y > 12:
            return False
        return self.check_pattern(x, y, self.pattern_array["fiveC"], board)

    def pattern_five_D(self, x, y, board, player):
        if x < 3 or y < 3 or x > 12 or y > 12:
            return False
        return self.check_pattern(x, y, self.pattern_array["fiveD"], board)

    def pattern_five_E(self, x, y, board, player):
        if x < 2 or y < 2 or x > 13 or y > 13:
            return False
        return self.check_pattern(x, y, self.pattern_array["fiveE"], board)

    def pattern_five_F(self, x, y, board, player):
        if x < 2 or y < 2 or x > 13 or y > 13:
            return False
        return self.check_pattern(x, y, self.pattern_array["fiveF"], board)

    def pattern_fork_three(self, x, y, board, player):
        if x < 3 or y < 3 or x > 12 or y > 12:
            return False
        return self.check_pattern(x, y, self.pattern_array["FORK_THREE_A"], board) or self.check_pattern(
            x, y, self.pattern_array["FORK_THREE_A"], board
        )
